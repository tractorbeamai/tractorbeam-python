...
from ..types import graph_create_params
...
class GraphsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            "/graphs",
            body=maybe_transform(body, graph_create_params.GraphCreateParams),
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            "/graphs",
            body=await async_maybe_transform(body, graph_create_params.GraphCreateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=object,
