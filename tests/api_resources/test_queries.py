...
from tractorbeam.types import QueryQueryResponse, QueryDecodeResponse
...
class TestQueries:
    ...
    def test_raw_response_query(self, client: Tractorbeam) -> None:
        response = client.queries.with_raw_response.query(
            depth=0,
            graph_names=["string"],
            query="query",
        )
    ...
    def test_streaming_response_query(self, client: Tractorbeam) -> None:
        with client.queries.with_streaming_response.query(
            depth=0,
            graph_names=["string"],
            query="query",
        ) as response:
...
class TestAsyncQueries:
    ...
    async def test_method_query(self, async_client: AsyncTractorbeam) -> None:
        query = await async_client.queries.query(
            depth=0,
            graph_names=["string"],
            query="query",
        )
    ...
    async def test_raw_response_query(self, async_client: AsyncTractorbeam) -> None:
        response = await async_client.queries.with_raw_response.query(
            depth=0,
            graph_names=["string"],
            query="query",
        )
    ...
    async def test_streaming_response_query(self, async_client: AsyncTractorbeam) -> None:
        async with async_client.queries.with_streaming_response.query(
            depth=0,
            graph_names=["string"],
            query="query",
        ) as response:
