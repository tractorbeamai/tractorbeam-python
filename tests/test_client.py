...
from tractorbeam._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: Tractorbeam | AsyncTractorbeam) -> int:
...
class TestTractorbeam:
    client = Tractorbeam(base_url=base_url, api_token=api_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "tractorbeam/_legacy_response.py",
                        "tractorbeam/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "tractorbeam/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(TractorbeamError):
            with update_env(**{"TRACTORBEAM_API_TOKEN": Omit()}):
                client2 = Tractorbeam(base_url=base_url, api_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Tractorbeam) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(TRACTORBEAM_BASE_URL="http://localhost:5000/from/env"):
            client = Tractorbeam(api_token=api_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: Tractorbeam) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Tractorbeam) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Tractorbeam) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Tractorbeam(base_url=base_url, api_token=api_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Tractorbeam(base_url=base_url, api_token=api_token, _strict_response_validation=False)
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/graphs").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/graphs").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/graphs").mock(side_effect=retry_handler)

        response = client.graphs.with_raw_response.create(name="name")
    ...
    def test_omit_retry_count_header(
        self, client: Tractorbeam, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.graphs.with_raw_response.create(name="name", extra_headers={"x-stainless-retry-count": "42"})

        assert response.http_request.headers.get("x-stainless-retry-count") == "42"


class TestAsyncTractorbeam:
    client = AsyncTractorbeam(base_url=base_url, api_token=api_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(TractorbeamError):
            with update_env(**{"TRACTORBEAM_API_TOKEN": Omit()}):
                client2 = AsyncTractorbeam(base_url=base_url, api_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncTractorbeam) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(TRACTORBEAM_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncTractorbeam(api_token=api_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncTractorbeam) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncTractorbeam) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncTractorbeam) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncTractorbeam(base_url=base_url, api_token=api_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncTractorbeam(base_url=base_url, api_token=api_token, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        ...
        response = await client.graphs.with_raw_response.create(name="name")
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncTractorbeam, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.graphs.with_raw_response.create(
            name="name", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_get_platform(self) -> None:
        ...
        from tractorbeam._utils import asyncify
        from tractorbeam._base_client import get_platform 
